...
#sort_commands_perf =["./sort_demo_shadowed -h 0 -s 0 -m 1 -b "+str(y)+" -a  --level 3 >> {}/sort_"+LOG_FILE_PERF_ON_LVL3 +" 2>&1" for y in SORT_PARAMS]
sort_commands_perf =["./sort_demo -h 0 -s 0 -m 1 -b "+str(y)+" >> {}/sort_"+LOG_FILE_PERF_ON_LVL3 +" 2>&1" for y in SORT_PARAMS]
...
if __name__ == "__main__":
    ...
    runErrInj(benchmarkTagBase, telnetPasswd, sort_commands_perf, SORT_DEMO_DIR,  0, 2, 17)
