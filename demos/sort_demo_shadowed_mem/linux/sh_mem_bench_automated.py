...
SORT_PARAMS = [512] #4,8,16,32,64,128,256,
...
if __name__ == "__main__":
    ...
    benchmark(benchmarkTagBase, telnetPasswd, BIT_SORT_OLD,  sort_commands_baseline_old, SORT_DEMO_DIR)
    ...
    benchmark(benchmarkTagBase, telnetPasswd, BIT_GSM,      gsm_commands_baseline,    GSM_DEMO_DIR)
    benchmark(benchmarkTagBase, telnetPasswd, BIT_GSM_REL,  gsm_commands_rel,         GSM_DEMO_DIR)
    benchmark(benchmarkTagBase, telnetPasswd, BIT_GSM_PERF, gsm_commands_perf,        GSM_DEMO_DIR)
