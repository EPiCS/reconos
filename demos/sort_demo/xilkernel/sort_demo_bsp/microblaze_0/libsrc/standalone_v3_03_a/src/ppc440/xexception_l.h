...
#define XEXC_MACHINE_CHECK                 0x00001000
#define XEXC_DEBUG                         0x00000200
#define XEXC_ALL                           0x00029200

#define XEXC_ID_FIRST                      0
#define XEXC_ID_CRITICAL_INT               0
#define XEXC_ID_MACHINE_CHECK              1
#define XEXC_ID_DATA_STORAGE_INT           2
#define XEXC_ID_INSTUCTION_STORAGE_INT     3
#define XEXC_ID_NON_CRITICAL_INT           4
#define XEXC_ID_ALIGNMENT_INT              5
#define XEXC_ID_PROGRAM_INT                6
#define XEXC_ID_FPU_UNAVAILABLE_INT        7
#define XEXC_ID_SYSTEM_CALL                8
#define XEXC_ID_APU_AVAILABLE              9
#define XEXC_ID_DEC_INT                    10
#define XEXC_ID_FIT_INT                    11
#define XEXC_ID_WATCHDOG_TIMER_INT         12
#define XEXC_ID_DATA_TLB_MISS_INT          13
#define XEXC_ID_INSTRUCTION_TLB_MISS_INT   14
#define XEXC_ID_DEBUG_INT                  15
#define XEXC_ID_LAST                       15
