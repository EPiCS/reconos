...
// quick check whether data is sorted, checksum is sum over original data
int quick_check_data( unsigned int *data, unsigned int size, unsigned int checksum);

unsigned int generate_checksum(unsigned int * data, unsigned int size);
