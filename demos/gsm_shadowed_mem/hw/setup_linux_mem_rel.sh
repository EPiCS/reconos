...
#link to externals
ln -s $RECONOS/externals/easics $TARGET_DIR/pcores/easics_v1_00_a
...
sed -i -e 's/BEGIN fifo32_arbiter/BEGIN fifo32_arbiter_sh_rel/' $TARGET_DIR/system.mhs
