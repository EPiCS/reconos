...
def proc_control(n,mfsl_a,sfsl_a,mfsl_b,sfsl_b):
...
mhs.addPCore(mmu())
mhs.addPCore(xps_mem())

# insert proc_control
n = len(hwts)
mhs.addPCore(proc_control(len(hwts),"fsl_v20_%da" % n,"fsl_v20_%db" % n,"fsl_v20_%da" % (n+1),"fsl_v20_%db" % (n+1)))
